        ...
        <div className={UmbrellaClass}>
            ...
            <div className='Col Col--6 Col--s-12 Col--xs-12'>
                <div className='Info-wrapper'>
                    <h2 className='Heading'>Customize your Umbrella</h2>
                    ...
                    <div className='Upload'>
                        ...
                        <div className={UploadButtonClass} >
                            ...
                            <p className='Text--strong Text--ellipsis' onClick={onUploadLogo} style={{ cursor: 'pointer' }} >{fileName ? fileName : 'UPLOAD LOGO'}</p>
